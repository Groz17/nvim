return
  {
    ...
    keys = {
      ...
      { '<leader>j', function() require('trouble').next({ skip_groups = true, jump = true }) end, desc = 'Jump to the next item, skipping the groups', ft = 'trouble', buffer = true },
      { '<leader>k', function() require('trouble').previous({ skip_groups = true, jump = true }) end, desc = 'Jump to the previous item, skipping the groups', ft = 'trouble', buffer = true },
      { '<leader>J', function() require('trouble').last({ skip_groups = true, jump = true }) end, desc = 'Jump to the last item, skipping the groups', ft = 'trouble', buffer = true },
      { '<leader>K', function() require('trouble').first({ skip_groups = true, jump = true }) end, desc = 'Jump to the first item, skipping the groups', ft = 'trouble', buffer = true },
    },
  }
