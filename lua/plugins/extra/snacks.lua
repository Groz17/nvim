    ...
    explorer=
{
  ...
  keys = {
    -- press enter to return to lazygit (make it go away)
      ...
      -- { '<space><space>', function() Snacks.lazygit() end, desc = 'Lazygit' },
      ...
      { '<f18>n', -- same keybinding as emacs
        ...
        function()
          Snacks.win({
            file = vim.api.nvim_get_runtime_file('doc/news.txt', true)[2], --1 e plugin file
            width = 0.6,
            height = 0.6,
            wo = {
              spell = false,
