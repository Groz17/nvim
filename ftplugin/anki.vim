" see: https://github.com/lervag/dotnvim/blob/030f2e30a3144010f99e6739a6c61945d8851f07/ftplugin/markdown.vim#L9-L11

nnoremap <silent><buffer> <localleader>n <cmd>call CreateNotes()<cr>
nnoremap <silent><buffer> <localleader>p <cmd>call PrepareImage()<cr>
nnoremap <silent><buffer> <localleader>i <cmd>call ViewImage()<cr>
